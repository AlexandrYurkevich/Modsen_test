    ...
    return (
        <div>
            <div className='overlay'>
                <Paper elevation={3} className="app-bar">
                    <div className='columned-container'>
                        ...
                        <Button variant={openedTab !=1 ? 'outlined' : "contained"} color="primary" onClick={()=>setTab(1)}>
                            <SearchIcon color={openedTab !=1 ? "primary" : "white"}/>
                        </Button>
                        <Button variant={openedTab !=2 ? 'outlined' : "contained"} color="secondary" onClick={()=>setTab(2)}>
                            <BookmarkIcon color={openedTab !=2 ? "secondary" : "white"}/>
                        </Button>
                    </div>
                    <Link to = "/login">
                        <IconButton>
                ...
                {openedTab != 0 && <Paper elevation={3} style={{borderRadius: '0 8px 8px 0'}}>
            ...
            <div className='map-container'>
                ...
                >
                    <Map places={places} setPlaces={setPlaces} radius={radius}/>
                </MapContainer>
            </div>
        </div>
    );
